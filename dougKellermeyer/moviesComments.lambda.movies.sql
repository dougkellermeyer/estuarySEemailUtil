...
-- Example statement which passes-through source dougKellermeyer/atlas1/sample_mflix/movies documents without modification.
-- Use a WHERE clause to filter, for example: WHERE $my$column = 1234
SELECT JSON($flow_document);

-- Example statement demonstrating how to SELECT specific locations from documents of dougKellermeyer/atlas1/sample_mflix/movies.
